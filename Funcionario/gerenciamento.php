...
<head>
    ...
    <!-- Style -->
    <link href="/Funcionario/CSS/gerenciamento.css" rel="stylesheet" type="text/css" />
    <!-- Script -->
    <script src="/Funcionario/JAVASCRIPT/Tab.js" type="text/JavaScript" defer></script>
    <script src="/Funcionario/JAVASCRIPT/gerenciamento.js" type="text/JavaScript" defer></script>
</head>
        ...
        <div class="conteiner_lista_opcoes">
            <div class="lista-opcoes">
                <section class="opcoes">
                    <a href="/Funcionario/cadastrodechave.html">Adicionar chaves</a>
                    <a href="/Funcionario/alterarchave.html">Alterar chaves</a>
