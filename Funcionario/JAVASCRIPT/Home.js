...
var btnRightCarrossel = document.querySelector('#arrow_right_chaves');
var btnLeftCarrossel = document.querySelector('#arrow_left_chaves');
var itensCarrosselChaves = document.querySelectorAll('#Chaves_Li_Predio1');
var countChavesPreido = itensCarrosselChaves.length;
var currentCarrossel = 0;
console.log(countChavesPreido);
...
carrossel();
console.log(document.querySelector('.Main_Cont3.active').checked);