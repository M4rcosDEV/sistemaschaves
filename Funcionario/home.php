...
<head>
    ...
    <script src="../Funcionario/JAVASCRIPT/Home2.js" type="text/javascript" defer></script>
    <script src="../Funcionario/JAVASCRIPT/Home.js" type="text/javascript" defer></script>
    <!-- CSS ASSETS -->
...
<body>
    ...
    <div class="POPUPS">
        ...
        <div class="PoPuCadastroPredio">
            ...
            <form class="FormCadastroPredio" action="../Funcionario/PHP/Predio.php" method="POST">
                <div>
        ...
        <div class="PoPuExcluirPredio">
            ...
            <form class="FormExcluirPredio" action="../Funcionario/PHP/Predio.php" method="POST">
                <div>
                    <img src="../Assets/Prédio.png" alt="Ilustração Predio">
                    <div></div>
                </div>
            ...
            <div class="Main_Cont3_Bloco-Chaves">
                ...
                <div class="Bloco_Chaves">
                        <div class="arrow_left_div">
                            <button id="arrow_left_chaves">
                                <i class='bx bx-chevron-left' ></i>
                            </button>
                        </div>
                        <div class="arrow_right_div">
                            <button id="arrow_right_chaves">
                                <i class='bx bx-chevron-right'></i>
                            </button>
                        </div>
                    <div class="Container_Chaves_Ul">
                        <ul class="Bloco_Chaves_UL">
                            <li class="Bloco_Chaves_LI" id="Chaves_Li_Predio1">
                                <div>
                                    <input type="checkbox">
                                </div>
                                <div>
